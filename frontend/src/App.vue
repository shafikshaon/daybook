  ...
  <div id="app" :class="{ 'dark-mode': isDarkMode }">
    ...
    <nav class="mobile-drawer" :class="{ show: showMobileMenu }" v-if="!isAuthPage">
      ...
      <div class="mobile-drawer-content">
        <ul class="drawer-nav">
          ...
          <li class="drawer-nav-item">
            <router-link to="/assets" class="drawer-nav-link" @click="closeMobileMenu">
              <svg class="drawer-nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
          ...
          <li class="drawer-nav-item">
            <router-link to="/activity-logs" class="drawer-nav-link" @click="closeMobileMenu">
              <svg class="drawer-nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-2h-1v2H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
                <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6m0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5"/>
              </svg>
          ...
          <li class="drawer-nav-item">
            <router-link to="/categories" class="drawer-nav-link" @click="closeMobileMenu">
              <svg class="drawer-nav-icon" xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" viewBox="0 0 16 16">
                <path d="M0 1.5A1.5 1.5 0 0 1 1.5 0h13A1.5 1.5 0 0 1 16 1.5v13a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 14.5zM1.5 1a.5.5 0 0 0-.5.5V5h4V1zM1 6v3.5h4V6zm5 0v3.5h4V6zm5 0v3.5h4V6zm4-1V1h-4v4zM6 1v4h4V1zm4.5 9h-9a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5m.5 4.5h4v-4h-4z"/>
              </svg>
    ...
    <nav class="sidebar" :class="{ 'collapsed': !showSidebar }" v-if="!isAuthPage">
      <ul class="nav flex-column mt-3">
        ...
        <li class="nav-item">
          <router-link to="/assets" class="nav-link" active-class="active" :title="!showSidebar ? 'Assets' : ''">
            <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              <path d="M8 1a2.5 2.5 0 0 1 2.5 2.5V4h-5v-.5A2.5 2.5 0 0 1 8 1m3.5 3v-.5a3.5 3.5 0 1 0-7 0V4H1v10a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V4zM2 5h12v9a1 1 0 0 1-1 1H3a1 1 0 0 1-1-1z"/>
            </svg>
            <span v-if="showSidebar">Assets</span>
          </router-link>
        </li>
        ...
        <li class="nav-item">
          <router-link to="/activity-logs" class="nav-link" active-class="active" :title="!showSidebar ? 'Activity Logs' : ''">
            <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              <path d="M2 0a2 2 0 0 0-2 2v12a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V2a2 2 0 0 0-2-2zm12 1a1 1 0 0 1 1 1v12a1 1 0 0 1-1 1v-2h-1v2H2a1 1 0 0 1-1-1V2a1 1 0 0 1 1-1z"/>
              <path d="M3 3.5a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9a.5.5 0 0 1-.5-.5M3 6a.5.5 0 0 1 .5-.5h9a.5.5 0 0 1 0 1h-9A.5.5 0 0 1 3 6m0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5m0 2.5a.5.5 0 0 1 .5-.5h6a.5.5 0 0 1 0 1h-6a.5.5 0 0 1-.5-.5"/>
            </svg>
            <span v-if="showSidebar">Activity Logs</span>
          </router-link>
        </li>
        ...
        <li class="nav-item">
          <router-link to="/categories" class="nav-link" active-class="active" :title="!showSidebar ? 'Categories' : ''">
            <svg class="nav-icon" xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" viewBox="0 0 16 16">
              <path d="M0 1.5A1.5 1.5 0 0 1 1.5 0h13A1.5 1.5 0 0 1 16 1.5v13a1.5 1.5 0 0 1-1.5 1.5h-13A1.5 1.5 0 0 1 0 14.5zM1.5 1a.5.5 0 0 0-.5.5V5h4V1zM1 6v3.5h4V6zm5 0v3.5h4V6zm5 0v3.5h4V6zm4-1V1h-4v4zM6 1v4h4V1zm4.5 9h-9a.5.5 0 0 0-.5.5v4a.5.5 0 0 0 .5.5h9a.5.5 0 0 0 .5-.5v-4a.5.5 0 0 0-.5-.5m.5 4.5h4v-4h-4z"/>
            </svg>
            <span v-if="showSidebar">Categories</span>
          </router-link>
        </li>
        <li class="nav-item">
